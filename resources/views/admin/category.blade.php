                                        ...
                                        <div class="table-responsive">
                                            <table id="mytable" class="table dataTable table-striped table-hover">
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#popular{{ $category->id() }}" data-placement="top" title="Mark Popular">
                                                                <i class="bi bi-hand-thumbs-up-fill"></i></button>

                                                                <div class="form-group">
  <a href="{{ route('admin.category.update', ['category' => $category->id()]) }}" class="btn btn-success">
    <i class="bi bi-pen-fill"></i>
                                                      ...
                                                      <div class="modal fade" id="delete{{ $category->id() }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal fade" id="popular{{ $category->id() }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                <div class="modal-header">
                                                                  <h5 class="modal-title" id="exampleModalLabel">Are you sure?</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                  Do you really want to mark this category Popular? You can Remove it from Popular from Popular categories.
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    {{-- <form method="POST" action="{{ route('crud.destroy', $category->id) }}"> --}}
                                                                      <form action="{{ route('admin.category.popular', ['category' => $category->id()]) }}" method="POST">
                                                                      @csrf
                                                                      <div class="form-group">
                                                                        <input type="submit" value="Make Category Popular" class="btn btn-danger">
                                                                      </div>
                                                                    </form>
